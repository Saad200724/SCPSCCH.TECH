...
const CLI = () => {
  ...
  const commands: Record<string, string | string[]> = {
    ...
    about: [
      "╔═══════════════════════════════════════════════╗",
      "║         SCPSC CYBER HUB - MANIFESTO           ║",
      "╠═══════════════════════════════════════════════╣",
      "║  We are the tech enthusiasts of SCPSC,       ║",
      "║  exploring core CS modules, building skills, ║",
      "║  and growing together through code.          ║",
      "╚═══════════════════════════════════════════════╝",
    ],
    mission: [
      "◆ MISSION: Foster computer science learning at SCPSC",
      "◆ VISION: Build a strong tech community on campus",
      "◆ VALUES: Learning • Collaboration • Excellence",
    ],
    events: [
